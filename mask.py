...
def highlight_faces(image, faces, output_filename):
    ...
    fontb = ImageFont.truetype(r'/System/Library/Fonts/Supplemental/Arial Bold.ttf', 20)
    im = Image.open(image)
...
# Main starts here --------------------------------------------------------------------------------------
credential_path = r'./corded-nature-276111-a50cb4838855.json'  #modify this line
